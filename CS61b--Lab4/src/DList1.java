...
public class DList1 {
  ...
  public void insertFront(int i) {
    // Your solution here.
	  DListNode1 first = new DListNode1(i);
	  if(this.head != null) {
  ...
  public static void main(String[] args) {
    ...
    l.insertFront(9);
    System.out.println("\nInserting 9 at front.\nList with 9 is " + l + "size is: " + l.size);
    if (l.head == null) {
      System.out.println("head is null.");
    } else {
      if (l.head.item != 9) {
        System.out.println("l.head.item != 9 is " + l.head.item + "size is: " + l.size);
      }
      if (l.head.prev != null) {
        System.out.println("head.prev is wrong." + "size is: " + l.size);
      }
    }
    if (l.tail == null) {
      System.out.println("tail is null." + "size is: " + l.size);
    } else {
      if (l.tail.item != 9) {
        System.out.println("tail.item is wrong." + "size is: " + l.size);
      }
      if (l.tail.next != null) {
        System.out.println("tail.next is wrong." + "size is: " + l.size);
      }
    }
    if (l.size != 1) {
      System.out.println("size is wrong." + "size is: " + l.size);
    }

    l.insertFront(8);
    System.out.println("\nInserting 8 at front.\nList with 8 and 9 is " + l + "size is: " + l.size);
    if (l.head == null) {
      System.out.println("head is null." + "size is: " + l.size);
    } else {
      if (l.head.item != 8) {
        System.out.println("head.item is wrong." + "size is: " + l.size);
      }
      if (l.head.prev != null) {
        System.out.println("head.prev is wrong." + "size is: " + l.size);
      }
      if (l.head.next != l.tail) {
        System.out.println("head.next is wrong." + "size is: " + l.size);
      }
    }
    if (l.tail == null) {
      System.out.println("tail is null." + "size is: " + l.size);
      ...
      if (l.tail.prev != l.head) {
        System.out.println("tail.prev is wrong." + "size is: " + l.size);
      }
    }
    if (l.size != 2) {
      System.out.println("size is wrong." + "size is: " + l.size);
    ...
    l = new DList1(1, 2);
    System.out.println("\n\n### TESTING removeFront ###\nList with 1 and 2 is: " + l + "Size is: " + l.size);
    l.removeFront();
    System.out.println("\nRemoving front node.\nList with 2 is " + l + "size is: " + l.size);
    if (l.head.item != 2) {
    ...
    l.removeFront();
    System.out.println("\nRemoving front node.\nEmpty list is " + l + "size is: " + l.size);
    if (l.head != null) {
    ...
    if (l.size != 0) {
      System.out.println("size is wrong." + l.size);
    }
  }
